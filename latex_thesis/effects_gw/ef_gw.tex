...
This phase shift can be measured at the photodiode to an accuracy that is governed by the light’s photon shot noise $\sim 1/\sqrt{N}$, where N is the number of photons that enter the inter- ferometer from the laser.
%%
%%
%%
%%
