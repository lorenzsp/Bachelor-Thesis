...
When a gravitational wave passes through the detector, it changes the arm-length difference, thereby an optical system monitors the separations between the masses in such a way that the variations in the output of the photodiode are directly proportional to $\delta L$.
...
\makebox[\textwidth][c]{\includegraphics[width=0.9\textwidth]{effects_gw/interferometer}}
