...
%%
\pagebreak
In addition, as we have done for the binary black holes, we study the angular frequency spectrum of the gravitational waves.\\
Neverthless, the orbital angular frequency is characterized by a lot of noise, it is possible anyway to see that the $\omega$ has a value approximately $2 \, \milli \second ^{-1}$ before the merger, and a value approximately$6 \, \milli \second ^{-1}$ after the merging.
