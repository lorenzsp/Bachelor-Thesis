...
In general, massive objects such neutron stars could collapse under their own weighst, forming a black hole, however when this happens the gravitational wave strain manifests ring-down phase similiar to that one of the binary black holes.
 In our case, the binary neutron stars do not form a black hole, but, instead, they transfer matter between themselves.
 In order to analyze such process, let us study the rest mass density during the time evolution of the BNS.\\
