...
%%
%%
Each initial configuration is then evolved using the \texttt{ML\_BSSN} (\texttt{McLachlan} BSSN) thorn \cite{Brown:2008sb}, the gravitational wave information is extracted using \texttt{WeylScal4} thorn.\\
